...
from wiki_music.gui_lib import (BaseGui, CoverArtSearch, DataModel,
...
class Checkers(BaseGui):
    """ This class is not stand-alone. It should be inherited and attributes in
        __init__ should be redefined. It's purpose is to synchronize info
        between parser and GUI.
    """
...
class Buttons(BaseGui):
    """ This class is not stand-alone. It should be inherited. This class
        cotains the functions which bind to gui buttons."""
