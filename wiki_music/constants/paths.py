...
__all__ = ["ROOT_DIR", "DIR_FILE", "LOG_DIR", "MP3_TAG", "OUTPUT_FOLDER",
           "OFFLINE_DEBUG_IMAGES", "FILES_DIR", "PROFILE_DIR"]
...
OUTPUT_FOLDER: str = join(ROOT_DIR, "output")
...
#: directory containing profiling log
PROFILE_DIR: str = join(ROOT_DIR, "profiling")