...
from PyQt5.QtWidgets import (QMainWindow, QFileDialog, QAbstractItemView, QApplication, QCheckBox,
                             QTableWidgetItem, QTableView, QWidget, QVBoxLayout)
from PyQt5.QtCore import Qt, QVariant, QSortFilterProxyModel, QAbstractTableModel
